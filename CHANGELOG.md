...
| 23.06.2022 | [**1.7.3**](https://github.com/stnolting/neorv32/releases/tag/v1.7.3) | :rocket: **New release** _two years NEORV32!_ :tada: | |
...
| 02.06.2022 | [**1.7.2**](https://github.com/stnolting/neorv32/releases/tag/v1.7.2) | :rocket: **New release** | |
...
| 25.04.2022 | [**1.7.1**](https://github.com/stnolting/neorv32/releases/tag/v1.7.1) | :rocket: **New release** | |
...
| 08.04.2022 | [**1.7.0**](https://github.com/stnolting/neorv32/releases/tag/v1.7.0) | :rocket: **New release** |
...
| 09.03.2022 | **1.6.9** | :rocket: **New release** |
...
| 17.02.2022 | **1.6.8** | :rocket: **New release** |
...
| 28.01.2022 | **1.6.7** | :rocket: **New release** |
...
| 17.01.2022 | **1.6.6** | :rocket: **New release** |
...
| 16.12.2021 | **1.6.5** | :rocket: **New release** |
...
| 26.11.2021 | **1.6.4** | :rocket: **New release** |
...
| 02.11.2021 | **1.6.3** | :rocket: **New release** |
...
| 17.10.2021 | **1.6.2** | :rocket: **New release** |
...
| 28.09.2021 | **1.6.1** | :rocket: **New release** |
...
| 11.09.2021 | **1.6.0** | :rocket: **New release** |
...
| 13.08.2021 | **1.5.9** | :rocket: **New release** |
...
| 22.07.2021 | **1.5.8** | :rocket: **New release** |
...
| 23.06.2021 | **1.5.7** | :rocket: **New release** _one year NEORV32!_ :tada: |
...
| 01.06.2021 | **1.5.6.0** | :rocket: **New release** |
...
| 10.05.2021 | **1.5.5.0** | :rocket: **New release** |
...
| 17.04.2021 | **1.5.4.0** | :rocket: **New release** |
...
| 24.03.2021 | **1.5.3.0** | :rocket: **New release** |
...
| 01.03.2021 | **1.5.2.0** | :rocket: **New release** |
...
| 07.02.2021 | **1.5.1.0** | :rocket: **New release** |
...
| 10.01.2021 | **1.5.0.0** | :rocket: Renamed configuration generics: `*_USE` -> `*_EN` |
...
| 19.12.2020 | **1.4.9.0** | :rocket: Testbench: added memory-mapped triggers to trigger core's "machine software & external interrupts"; `sw/example/cpu_test`: removed CFU tests, added `MEI` and `MSI` tests; added **RISC-V-Compliance Test Framework** to repository (`riscv-compliance/`), core passes all `rv32` tests (riscv-compliance v2.1) |
...
| 01.12.2020 | **1.4.8.0** | :rocket: :warning: fixed bug in CPU-internal co-processor interface; optimized multiplier unit (~1 faster); added CPU `A` (atomic) extension support (only `lr.w` and `sc.w` instructions yet); added `lock` signal to CPU and processor's external bus interface |
...
| 11.11.2020 | **1.4.7.0** | :rocket: Further optimized pipeline front-end: Jumps and branches are one cycle faster (+5% coremark performance); updated synthesis results; updated performance results; added `hello_world` example program |
...
| 24.10.2020 | **1.4.6.0** | :rocket: Completely reworked external memory interface (WISHBONE), removed now-obsolete processor generic `MEM_EXT_REG_STAGES`; added processor wrapper with **AXI4-Lite interface** |
...
| 13.10.2020 | **1.4.5.0** | :rocket: An official *open-source RISC-V architecture ID* was assigned to the project: decimal = `19`, 32-bit hexadecimal = `0x00000013` - software can retrieve the ID from the `marchid` CSR |
...
| 05.10.2020 | **1.4.4.0** | :rocket: :warning: Fixed bug in external memory interface: Executing code from external memory was causing an instruction fetch stall |
...
| 14.08.2020 | **1.3.7.0** | :rocket: Simplified CPU fetch engine; added configurable CPU instruction prefetch buffer (ipb) FIFO; optimized CPU execute engine; updated performance data |
...
| 03.08.2020 | **1.3.6.0** | :rocket: Relocated `DEVNULL` (changed base address); minor edits, optimization and clean-ups |
...
| 23.06.2020 | **0.0.2.3** | :rocket: Publication |
