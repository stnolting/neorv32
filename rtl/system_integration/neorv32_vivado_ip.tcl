...
set_property tooltip      {Scalar cryptographic - NIST AES decryption}     [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zknd"   -component [ipx::current_core]]
set_property display_name {RISC-V Zkne ISA extension}                      [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zkne"   -component [ipx::current_core]]
set_property tooltip      {Scalar cryptographic - NIST AES encryption}     [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zkne"   -component [ipx::current_core]]
set_property display_name {RISC-V Zknh ISA extension}                      [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zknh"   -component [ipx::current_core]]
set_property tooltip      {Scalar cryptographic - NIST hash functions}     [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zknh"   -component [ipx::current_core]]
set_property display_name {RISC-V Zksed ISA extension}                     [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksed"  -component [ipx::current_core]]
set_property tooltip      {Scalar cryptographic - ShangMi block cyphers}   [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksed"  -component [ipx::current_core]]
set_property display_name {RISC-V Zksh ISA extension}                      [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksh"   -component [ipx::current_core]]
set_property tooltip      {Scalar cryptographic - ShangMi hash functions}  [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksh"   -component [ipx::current_core]]
...
ipgui::move_param -component [ipx::current_core] -order 20 [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksed"  -component [ipx::current_core]] -parent [ipgui::get_groupspec -name "CPU Configuration" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 21 [ipgui::get_guiparamspec -name "CPU_EXTENSION_RISCV_Zksh"   -component [ipx::current_core]] -parent [ipgui::get_groupspec -name "CPU Configuration" -component [ipx::current_core]]
