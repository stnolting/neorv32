project_new marsokhod3 -overwrite
...
# ================================
set_global_assignment -name TOP_LEVEL_ENTITY marsokhod3
...
set_global_assignment -name VHDL_FILE ../../backend/marsokhod3/rtl/marsokhod3.vhd
