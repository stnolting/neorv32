...
class Project:
    def __init__(self, root):
        ...
        self.Filesets = Filesets(
            ...
            designs=[
                Design("Minimal", vhdl=["{}/processor_templates/neorv32_ProcessorTop_Minimal*.vhd".format(self.RTLDir)]),
                Design(
                    "MinimalBoot", vhdl=["{}/processor_templates/neorv32_ProcessorTop_MinimalBoot.vhd".format(self.RTLDir)]
                ),
                Design("UP5KDemo", vhdl=["{}/processor_templates/neorv32_ProcessorTop_UP5KDemo.vhd".format(self.RTLDir)]),
                Design(
                    "MixedLanguage",
                    vhdl=["{}/processor_templates/neorv32_ProcessorTop_Minimal*.vhd".format(self.RTLDir)],
                    verilog=[
