...
def Example(board: str, design: str, posargs: str) -> str:
    ...
    return " ".join(
        Run(
            ...
            top=boardtop,
            id=design,
            board_srcs=["{}/{}.vhd".format(PRJ.Examples, boardtop)],
...
def GenerateExamplesJobMatrix():
    print(
        ...
        + str(
            [
                {"board": "UPduino", "design": "MinimalBoot", "bitstream": "neorv32_UPduino_v3_MinimalBoot.bit"},
                {"board": "UPduino", "design": "UP5KDemo", "bitstream": "neorv32_UPduino_v3_UP5KDemo.bit"},
                {"board": "Fomu", "design": "Minimal", "bitstream": "neorv32_Fomu_pvt_Minimal.bit"},
                {"board": "Fomu", "design": "MinimalBoot", "bitstream": "neorv32_Fomu_pvt_MinimalBoot.bit"},
                {"board": "Fomu", "design": "MixedLanguage", "bitstream": "neorv32_Fomu_pvt_MixedLanguage.bit"},
                {"board": "Fomu", "design": "UP5KDemo", "bitstream": "neorv32_Fomu_pvt_UP5KDemo.bit"},
                {"board": "iCESugar", "design": "Minimal", "bitstream": "neorv32_iCESugar_Minimal.bit"},
                {"board": "iCESugar", "design": "MinimalBoot", "bitstream": "neorv32_iCESugar_MinimalBoot.bit"},
                {
                    "board": "OrangeCrab",
                    "design": "MinimalBoot",
