...
enum NEORV32_UART_DATA_enum {
  ...
  UART_DATA_TX_FIFO_SIZE_LSB = 12, /**< UART data register(12) (r/-): log2(TX FIFO size), LSB */
  UART_DATA_TX_FIFO_SIZE_MSB = 15, /**< UART data register(15) (r/-): log2(TX FIFO size), MSB */
};
/**@}*/
