...
enum NEORV32_TWD_CTRL_enum {
  ...
  TWD_CTRL_IRQ_COM_BEG  = 14, /**< TWD control register(14) (r/w): IRQ if begin of communication */
  TWD_CTRL_IRQ_COM_END  = 15, /**< TWD control register(15) (r/w): IRQ if end of communication */
...
//TWD_CTRL_???          = 24, /**< TWD control register(24) (r/-): reserved */
