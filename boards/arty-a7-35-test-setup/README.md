...
It uses the simplified [`neorv32_test_setup.vhd`](`rtl/top_templates/neorv32_test_setup.vhd`) top entity, which is a wrapper for the actual processor
...
:information_source: See the top entity [`rtl/top_templates/neorv32_test_setup.vhd` ](https://github.com/stnolting/neorv32/blob/master/rtl/top_templates/neorv32_test_setup.vhd) for the configuration details.
...
:information_source: See the top entity [`rtl/top_templates/neorv32_test_setup.vhd` ](https://github.com/stnolting/neorv32/blob/master/rtl/top_templates/neorv32_test_setup.vhd) for the actual interface signals and
[`arty_a7_35_test_setup.xdc`](https://github.com/stnolting/neorv32/blob/master/boards/arty-a7-35-test-setup/arty_a7_35_test_setup.xdc) for the according pin mappings.

* Clock: 100Mhz from on-board oscillator
* Reset: Via dedicated "RESET" button
