...
if {$make_assignments} {
  ...
  set_global_assignment -name VHDL_FILE ./../../../rtl/core/neorv32_dmem.default.vhd -library neorv32
  set_global_assignment -name VHDL_FILE ./../../../rtl/core/neorv32_imem.default.vhd -library neorv32
