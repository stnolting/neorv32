...
3+| Number of TX (send) <<_stream_link_interface_slink>> channels to implement. Valid values are 0..8.
|======
...
3+| Number of RX (receive) <<_stream_link_interface_slink>> channels to implement. Valid values are 0..8.
|======
...
3+| Internal FIFO depth for all implemented TX links. Valid values are 1..32k and have to be a power of two.
|======
...
3+| Internal FIFO depth for all implemented RX links. Valid values are 1..32k and have to be a power of two.
|======
...
3+| Number of channels of the <<_pulse_width_modulation_controller_pwm>> to implement (0..60)
