...
.RISC-V GCC C-Api Documentation
[TIP]
A copy of the official RISC-V GCC C-API reference (https://github.com/riscv-non-isa/riscv-c-api-doc) is located
in the project's `docs` folder: `neorv32/docs/riscv-c-api.pdf`
