...
| CRC          | Cyclic redundancy check unit                                   | 135 | 117 |        0 |    0
| DM           | On-chip debugger - debug module                                | 391 | 220 |        0 |    0
| DMA          | Direct memory access controller                                | 313 | 257 |        0 |    0
...
| iCACHE       | Instruction cache (2x4 blocks, 64 bytes per block)             | 417 | 294 |     4096 |    0
| dCACHE       | Data cache (4 blocks, 64 bytes per block)                      | 308 | 167 |     2112 |    0
...
| SLINK        | Stream link interface (RX/TX FIFO depth=32)                    | 104 |  73 |     2048 |    0
