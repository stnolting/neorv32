...
│├icons            - Symbols for webpage
│├src_adoc         - AsciiDoc sources for this document
│├references       - Data sheets and RISC-V specs.
│└userguide        - .adoc sources for NEORV32 user guide (UG)
├rtl               - VHDL sources
│├core             - Sources of the CPU & SoC
│├test_setups      - Minimalistic SoC test setups for getting started (->UG)
│└wrappers         - Alternative top entities/wrappers
