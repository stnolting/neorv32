...
* completely described in behavioral, platform-independent VHDL - no vendor- or technology-specific primitives, attributed, macros, libraries, etc. are used at all
...
** fully RISC-V compatible: passes the https://github.com/stnolting/neorv32-verif[official architecture tests]
