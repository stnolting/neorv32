...
The NEORV32 CPU passes the official **RISC-V Architecture Compatibility Tests**. This framework is used to check
RISC-V implementations for compatibility to the official RISC-V user/privileged ISA specifications. The NEORV32 port
of this test framework is available in `sw/riscv-arch-test`.
