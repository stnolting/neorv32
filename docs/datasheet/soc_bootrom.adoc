...
[TIP]
This module/file can be replaced by a platform-specific module/file (for example, to use technology-specific memory IP).
See section <<_replaceable_modules>> for more information.
