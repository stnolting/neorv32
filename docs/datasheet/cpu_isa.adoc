...
In additions to the base counters the NEORV32 CPU provides up to 29 hardware performance monitors (HPM 3..29),
which can be used to benchmark applications. Each HPM consists of an N-bit wide counter split into a high-word 32-bit
