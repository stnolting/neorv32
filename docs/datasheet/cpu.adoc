...
can be enabled/disabled by the <<_cpu_trace_en>> tuning option.

The trace port is backwards compatible to the **RISC-V Formal Interface (RVFI)** defined by Yosys
...
| `insn`      |    32 | `rvfi_insn`      | Instruction word; compressed instructions are shown in their decompressed 32-bit format
